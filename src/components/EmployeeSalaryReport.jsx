          ...
          <>
            ...
            <div className="employee-info-card">
              ...
              <div className="info-item">
                ...
                <span className="info-value">¥{Number(employee.basic_salary).toLocaleString()}</span>
              </div>
              <div className="info-item">
                  ...
                  <>
                    ...
                    <div className="yearly-cards-summary">
                      <div className="sum-box">
                        ...
                        <span className="sum-val">¥{Number(summary.total_allowances).toLocaleString()}</span>
                      </div>
                      <div className="sum-box">
                      ...
                      <div className="payslip-grid">
                        <div className="payslip-column">
                          ...
                          <div className="payslip-row">
                            ...
                            <span>+ ¥{Number(sal.allowances).toLocaleString()}</span>
                          </div>
                        ...
                        <div className="payslip-column">
                          ...
                          <div className="payslip-row">
                            ...
                            <span>- ¥{Number(sal.leave_deduction).toLocaleString()}</span>
                          </div>
                          <div className="payslip-row">
                            <span>Other Deductions</span>
                            <span>- ¥{Number(sal.other_deductions).toLocaleString()}</span>
                          </div>
                          <div className="payslip-row total">
                            <span>Total Deductions</span>
                            <span>- ¥{(Number(sal.leave_deduction) + Number(sal.other_deductions)).toLocaleString()}</span>
                          </div>
                        </div>
                      </div>
            ...
            <div className="report-footer-signatures">
              ...
              <div className="sig-line">
                <div className="line"></div>
                <p>Authorized Admin Signature & Stamp</p>
              </div>
            </div>
          </>
        )}
